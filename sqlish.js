...
(function (self) {
    ...
    Sql = function (config) {
        ...
        sql.replace = function (tableName, obj) {
            ...
            // Reset this inner sql object since this is a verb
            this.sql = "REPLACE INTO " + tableName + " (" +
        ...
        sql.orderBy = function (fields, direction) {
            ...
            if (direction.toUpperCase() === "ASC" || direction >= 0) {
                this.sql += " ASC";
